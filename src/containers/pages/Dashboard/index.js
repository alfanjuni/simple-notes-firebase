...
class Dashboard extends Component{
    ...
    // componentDidMount() {
    //    const userData = localStorage.getItem('userData'); //memanggil data dari localstorage
        ...
        return(
            <div className="container">
                <div className="input-form">
                    ...
                    <textarea name="" id="" cols="30" rows="10" placeholder="content" className="input-content" value={content} onChange={(e) => this.onInputChange(e, 'content')} >
